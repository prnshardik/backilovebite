                        ...
                        <form name="form" action="{{ route('back.categories.update') }}" id="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <input type="file" class="form-control dropify" id="image" name="image" data-show-remove="false" data-height="200" data-default-file="{{ $data->image ?? '' }}" data-max-file-size="3M" data-show-errors="true"  data-allowed-file-extensions="jpg png jpeg JPG PNG JPEG"  data-max-file-size-preview="3M" required="required" />
