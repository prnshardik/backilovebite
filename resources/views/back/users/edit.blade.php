...
@section('content')
    {{-- <div class="page-heading mt-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><span class="text-dark font-weight-bold">Update</span></li>
        </ol>
    </div> --}}
                        ...
                        <form name="form" action="{{ route('back.users.update') }}" id="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <input type="file" class="dropify" id="image" name="image" data-default-file="{{ $data->image ?? '' }}"  data-show-remove="false"  >
