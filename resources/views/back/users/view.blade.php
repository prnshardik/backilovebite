                    ...
                    <div class="ibox-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="lastname" id="lastname" class="form-control" placeholder="Plese enter lastname" value="{{ $data->lastname ?? '' }}" disabled="disabled" />
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <input type="file" class="dropify" id="image" name="image" data-default-file="{{ $data->image ?? '' }}" data-show-remove="false" disabled="disabled" />
