    ...
    <div class="page-content fade-in-up">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <h1 class="ibox-title">FAQs</h1>
                        <h1 class="pull-right">
                            <a class="btn btn-primary pull-right ml-2" style="margin-top: 8px;margin-bottom: 5px" href="{{ route('back.FAQs.create') }}">Add New</a>
                        </h1>
                    </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function change_status(object){
            ...
            if (confirm(msg)) {
                $.ajax({
                    "url": "{!! route('back.FAQs.change.status') !!}",
                    "dataType": "json",
                    "type": "POST",
                    "data":{
                        id: id,
