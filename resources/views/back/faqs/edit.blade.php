        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form name="form" action="{{ route('back.FAQs.update') }}" id="form" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="row">                                
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <textarea name="discription" id="discription" class="form-control" placeholder="Plese enter discription" rows="3" cols="10">{{ $data->discription ??'' }}</textarea>
