        ...
        /** index */
            public function index(Request $request){
                if($request->ajax()){
                    ...
                    $data = Review::select('id', 'name', 'title' ,'status',
                                            DB::Raw("SUBSTRING(".'message'.", 1, 50) AS message"),
                                            DB::Raw("CASE
                                                        WHEN ".'image'." != ''
                    ...
                    return Datatables::of($data)
                            ...
                            ->addColumn('action', function($data){
                                return ' <div class="btn-group">
                                                <a href="'.route('back.reviews.view', ['id' => base64_encode($data->id)]).'" class="btn btn-default btn-xs">
                                                    <i class="fa fa-eye"></i>
                                                </a> &nbsp;

                                                <a href="'.route('back.reviews.edit', ['id' => base64_encode($data->id)]).'" class="btn btn-default btn-xs">
                            ...
                            ->editColumn('image', function($data){
                                return '<img class="image" src="'.$data->image.'" border="0" width="40" height="40" class="img-rounded" align="center"> &nbsp;&nbsp;';
                            })
